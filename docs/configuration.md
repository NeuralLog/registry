...
This document describes the configuration options for NeuralLog Registry.

## Configuration Options

The Registry can be configured using the following options:
...
Registry also supports configuration via environment variables:
...
You can also configure Registry using a configuration file:
